 ...
 * This file demonstrates how to integrate Forgeurn with a web frontend
 */

// For React/Vue/Angular applications
export class ForgeurnClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ForgeurnClient(provider, contractAddress);
